  ...
  $.fn.orbit = function(options) {
      ...
      return this.each(function() {
        ...
        slides.eq(activeSlide)
          .css({
            "z-index": numberSlides,
            left: options.frontendLeft,
            "width": options.frontendWidth + "px",
            top: 0,
            "border": options.frontendBorder
          })
          .fadeIn(function() {
            slides.eq(activeSlide).siblings().css({
              "width": options.backendWidth + "px",
              top: options.backendTop
            });

          });
        slides.eq((activeSlide - 2) % numberSlides).css({
          "left": options.backendLeft2,
          "z-index": numberSlides - 2,
          "top": options.backendTop2,
          "width": options.backendWidth2 + "px",
          "border": options.backendBorder2
        });
        slides.eq((activeSlide - 1) % numberSlides).css({
          "left": options.backendLeft,
          "z-index": numberSlides - 1,
          "top": options.backendTop,
          "width": options.backendWidth + "px",
          "border": options.backendBorder
        });
        slides.eq((activeSlide) % numberSlides).css({
          "left": options.frontendLeft,
          "z-index": numberSlides,
          "width": options.frontendWidth + "px",
          top: 0
        ...
        for (act = activeSlide + 3; act < numberSlides; act++) {
          slides.eq(act % numberSlides).css({
            ...
            if (options.animation == "horizontal-push") {
              ...
              if (slideDirection == "next") {
                slides
                  ...
                  .animate({
                    "left": options.frontendLeft + "px",
                    "width": options.frontendWidth + "px",
                    "top": "0px"
                  }, options.animationSpeed, resetAndUnlock);
                slides
                  .eq(prevActiveSlide).css({
                    "z-index": numberSlides - 1,
                    "border": options.backendBorder
                  })
                  .animate({
                    "left": options.backendLeft,
                    "width": options.backendWidth + "px",
                    top: options.backendTop + "px"
                  }, options.animationSpeed);
                slides
                  .eq(prevActiveSlide1).css({
                    "z-index": numberSlides - 2,
                    "border": options.backendBorder2
                  })
                  .animate({
                    "left": "0px",
                    "width": options.backendWidth2 + "px",
                    top: options.backendTop2 + "px"
                  }, options.animationSpeed);
                slides
                  .eq(nextActiveSlide).css({
                    "z-index": numberSlides - 1,
                    "border": options.backendBorder
                  })
                  .animate({
                    "left": options.backendLeft3 + "px",
                    "width": options.backendWidth + "px",
                    top: options.backendTop + "px"
                  }, options.animationSpeed);
                slides
                  .eq(nextActiveSlide1).css({
                    "z-index": numberSlides - 2,
                    "border": options.backendBorder2
                  })
                  .animate({
                    "left": options.backendLeft4 + "px",
                    "width": options.backendWidth2 + "px",
                    top: options.backendTop2 + "px"
                  }, options.animationSpeed);
                /*slides
                ...
                if (numberSlides > 5) {
                  for (j = numberSlides - 5; j >= 1; j--) {
                    slides.eq((prevActiveSlide1 - j + numberSlides) % numberSlides).css({
                      "z-index": numberSlides - 2 - j
                    });
                  }
                }
              }
              if (slideDirection == "prev") {
                ...
                if (numberSlides > 5) {
                  slides.eq((prevActiveSlide1 + 1 + numberSlides) % numberSlides).css({
                    "z-index": numberSlides - 4
                  });
                }
              }
            }
